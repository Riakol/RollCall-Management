        ...
        Row(modifier = Modifier.height(IntrinsicSize.Min)) {
            ...
            Column(
                ...
                Row(
                    ...
                    // Счетчик учеников справа сверху
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            text = schoolClass.studentCount.toString(),
                            color = TextWhite,
                            fontSize = 16.sp
                        )
                    }
                ...
                // Стек аватарок (Preview Students)
                Row(verticalAlignment = Alignment.CenterVertically) {
                    schoolClass.previewStudents.forEachIndexed { index, student ->
                        Surface(
                            shape = CircleShape,
                            color = Color.Gray, // В будущем здесь будет AsyncImage
                            modifier = Modifier
                                .size(32.dp)
                    ...
                    // Если студентов больше, чем в превью, показываем "+N"
